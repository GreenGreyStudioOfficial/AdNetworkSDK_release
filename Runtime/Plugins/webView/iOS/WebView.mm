...
extern "C" {
    void *_CWebViewPlugin_InitIOS(const char *gameObjectName, BOOL transparent, BOOL zoom, const char *ua, BOOL enableWKWebView, int contentMode, BOOL allowsLinkPreview);
    void _CWebViewPlugin_DestroyIOS(void *instance);
    void _CWebViewPlugin_SetMarginsIOS(
        void *instance, float left, float top, float right, float bottom, BOOL relative);
    void _CWebViewPlugin_SetVisibilityIOS(void *instance, BOOL visibility);
    void _CWebViewPlugin_SetAlertDialogEnabledIOS(void *instance, BOOL visibility);
    void _CWebViewPlugin_SetScrollbarsVisibilityIOS(void *instance, BOOL visibility);
    void _CWebViewPlugin_SetScrollBounceEnabledIOS(void *instance, BOOL enabled);
    BOOL _CWebViewPlugin_SetURLPatternIOS(void *instance, const char *allowPattern, const char *denyPattern, const char *hookPattern);
    void _CWebViewPlugin_LoadURLIOS(void *instance, const char *url);
    void _CWebViewPlugin_LoadHTMLIOS(void *instance, const char *html, const char *baseUrl);
    void _CWebViewPlugin_EvaluateJSIOS(void *instance, const char *url);
    int _CWebViewPlugin_ProgressIOS(void *instance);
    BOOL _CWebViewPlugin_CanGoBackIOS(void *instance);
    BOOL _CWebViewPlugin_CanGoForwardIOS(void *instance);
    void _CWebViewPlugin_GoBackIOS(void *instance);
    void _CWebViewPlugin_GoForwardIOS(void *instance);
    void _CWebViewPlugin_ReloadIOS(void *instance);
    void _CWebViewPlugin_AddCustomHeaderIOS(void *instance, const char *headerKey, const char *headerValue);
    void _CWebViewPlugin_RemoveCustomHeaderIOS(void *instance, const char *headerKey);
    void _CWebViewPlugin_ClearCustomHeaderIOS(void *instance);
    void _CWebViewPlugin_ClearCookiesIOS();
    void _CWebViewPlugin_SaveCookiesIOS();
    const char *_CWebViewPlugin_GetCookiesIOS(const char *url);
    const char *_CWebViewPlugin_GetCustomHeaderValueIOS(void *instance, const char *headerKey);
    void _CWebViewPlugin_SetBasicAuthInfoIOS(void *instance, const char *userName, const char *password);
    void _CWebViewPlugin_ClearCacheIOS(void *instance, BOOL includeDiskFiles);
}
...
void _CWebViewPlugin_SetAlertDialogEnabledIOS(void *instance, BOOL enabled)
{
    if (instance == NULL)
        return;
    CWebViewPlugin *webViewPlugin = (__bridge CWebViewPlugin *)instance;
...
void _CWebViewPlugin_EvaluateJSIOS(void *instance, const char *js)
{
    if (instance == NULL)
        return;
    CWebViewPlugin *webViewPlugin = (__bridge CWebViewPlugin *)instance;
